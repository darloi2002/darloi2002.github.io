...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Tim anh đang đập nhanh " + (thePercent+899) + " bpm";
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-body').innerHTML = 'Ngày mai mình gặp nhau rồi đó <i class="fas fa-heart"></i> <i class="fas fa-heart"></i> <i class="fas fa-heart"></i> ';
